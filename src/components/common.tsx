...
const AVATAR_COLORS = ['#d97706', '#2563eb', '#16a34a', '#7c3aed', '#e11d48', '#0891b2', '#0d9488']
  ...
  const inline: React.CSSProperties =
    variant === 'primary'
      ...
      : variant === 'default'
        ...
        : {}
  return (
    <button type={type} onClick={onClick} title={title} className={`${base} ${styles[variant]}`} style={inline}>
      {children}
    </button>
  )
}
